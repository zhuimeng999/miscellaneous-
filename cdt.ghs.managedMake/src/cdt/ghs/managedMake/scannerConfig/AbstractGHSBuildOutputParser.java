...
import cdt.ghs.managedMake.Activator;
...
public abstract class AbstractGHSBuildOutputParser implements IScannerInfoConsoleParser {

	protected static final String[] COMPILER_INVOCATION = { "ccv850e", "cxv850e"//$NON-NLS-1$ //$NON-NLS-2$
	};
	...
	protected GHSBuildOutputParserUtility fUtility;

	protected boolean fBMultiline = false;
	protected String fSMultiline = ""; //$NON-NLS-1$

	protected String[] fCompilerCommands = { "ccv850e", "cxv850e" }; //$NON-NLS-1$ //$NON-NLS-2$
	...
	protected synchronized GHSBuildOutputParserUtility getUtility() {
		if (fUtility == null)
			fUtility = new GHSBuildOutputParserUtility(fProject, fWorkingDir, fMarkerGenerator);
