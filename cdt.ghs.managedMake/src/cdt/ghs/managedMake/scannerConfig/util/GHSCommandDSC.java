...
package cdt.ghs.managedMake.scannerConfig.util;
...
public class GHSCommandDSC extends CCommandDSC {

	public GHSCommandDSC(boolean cppFileType) {
		super(cppFileType);
	}

	public GHSCommandDSC(boolean cppFileType, IProject project) {
